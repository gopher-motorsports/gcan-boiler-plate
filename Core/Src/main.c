...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, GSENSE_LED_Pin|HEATBEAT_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GSENSE_LED_Pin HEATBEAT_LED_Pin */
  GPIO_InitStruct.Pin = GSENSE_LED_Pin|HEATBEAT_LED_Pin;
